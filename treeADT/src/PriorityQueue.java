...
public class PriorityQueue {
    ...
    public static void main(String[] args) {
        ...
        int[] arr = new int[]{34, 1106, 2, 5, 18, 18, 46, 5, 49, 4, 5, 3, 1, 2, 5, 3, 7, 2, 3, 2, 2, 2, 1, 10, 9, 1, 5, 2, 3, 15, 1, 3, 352, 101, 173, 178, 775, 121, 85, 296, 357, 3, 13, 210, 140, 381, 373, 106, 26, 289, 318, 514, 134, 35, 81, 9, 94, 5, 0};
        pq.addAll(arr);
